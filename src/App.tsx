    ...
    try {
      ...
      const res = await axios.post(
        'https://api.openai.com/v1/images/generations',
        {
          ...
          // prompt: `"Create of an immense aquarium scaped in the style of Takashi Aman, featuring ${country} style mountains, little trees, and a sand path, along with rocks. There are only a few ${animal}s, emphasizing the aquascaping. The image should be hyperrealistic and ultra-detailed. In the foreground, there is an an imperfect little girl looking into the aquarium, her gaze fixated on the ${animal}. "Ethereal lights${color} illuminate the scene, adding to the magical ${moods} atmosphere."
          // prompt: `"Create an ultra-realistic 3D illustration in IMAX style, Cinematic 64k, UHD-HDR, showcasing an unexpected family scene: Three little cute ${animal}s, symbolizing innocence and curiosity, are poking their heads out of an eggshell in a nest. The scene captures a moment of disbelief with ${color} highlights, emphasizing the theme of protection and surprise. Next to the nest stands a huge ${moods} father ${animal}, embodying the theme of protection and surprise. The setting is enriched with subtle hints of ${fruit} and elements that echo the cultural essence of ${country}, adding depth and a personalized touch to the ${moods} atmosphere. The scene not only portrays a humorous and surprising family moment but also integrates the user's preferences in a subtle and creative way."`,
          prompt: `"Create a hyper-realistic photography-style image in ultra HD 8k resolution, featuring thick white clouds in the shape of a majestic ${animal}. The afternoon sunlight penetrates the clouds, which have a hue of ${color}. Small birds are flying around, and various animals are eating in the meadow. The sky is colored in shades of ${color}, embodying a ${country} atmosphere without specific architectural elements, showcasing intricate details."`,
          n: 1,
          size: "1024x1024",
        },
        {
    ...
    <>
      <div style={getBackgroundStyle(moods)} className="min-h-screen">
        ...
        <main>
          ...
          <div className="max-w-2xl mx-auto p-6 bg-white/[0.8] rounded-lg shadow-lg text-center font-gangwon">
            <h1 className="text-xl font-bold">오늘 나는?</h1>
            <div className='flex justify-between flex-wrap mt-2'>
              ...
              <div className='w-full my-2 text-left flex items-center justify-between'>
                <p className='inline-block text-nomal'>당신이 평소 좋아하는 동물은?</p>
                <input
                  type="text"
                  value={animal}
                  onChange={(e) => setAnimal(e.target.value)}
                  placeholder="🙈 ex)원숭이"
                  className="border-b-2 text-nomal ml-3 outline-none w-2/3 bg-none py-1 indent-3"
                />
              </div>
              <div className='w-full my-2 text-left flex items-center justify-between'>
                <p className='inline-block text-nomal'>당신이 평소 좋아하는 과일은?</p>
                <input
                  type="text"
                  value={fruit}
              ...
              <div className='w-full my-2 text-left flex items-center justify-between'>
                <p className='inline-block text-nomal'>당신이 평소 좋아하는 색상은?</p>
                <input
                  type="text"
                  value={color}
              ...
              <div className='w-full my-2 text-left flex items-center justify-between'>
                <p className='inline-block text-nomal'>당신이 현재 가고싶은 나라는?</p>
                <input
                  type="text"
                  value={country}
            ...
            <button
              ...
              className="bg-blue-500 text-white p-2 font-nanum rounded w-full mx-auto mt-2 hover:bg-blue-700 transition-colors"
            >
              나의 기분을 AI 에게 물어보기
            </button>
          </div>
